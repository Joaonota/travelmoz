...
import 'package:travelmoz/custimizado/lazerCustimizado/avaliacaoLazer.dart';

import 'package:travelmoz/models/lazer.dart';

class DetalheAnimacaoLazer extends StatefulWidget {
  const DetalheAnimacaoLazer(
      {Key? key,
      required this.lazer,
  ...
  @override
  State<DetalheAnimacaoLazer> createState() => _DetalheAnimacaoLazerState();
}

class _DetalheAnimacaoLazerState extends State<DetalheAnimacaoLazer> {
  @override
  Widget build(BuildContext context) {
    final topPadind = MediaQuery.of(context).padding.top;
    final imageurl = widget.lazer.fotos;
      ...
      children: [
        ...
        Positioned.fill(
          ...
          child: TranslationAnimation(
              child: AvaliacaoLazer(
                  lazers: widget.lazer) //DetalheUser(mozs: mozs),
              ),
        )
      ],
    );
